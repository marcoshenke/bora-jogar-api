...
ActiveRecord::Schema[7.1].define(version: 2026_06_03_193749) do
  ...
  create_table "player_profile_positions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["player_profile_id"], name: "index_player_profile_positions_on_player_profile_id"
    t.index ["position_id"], name: "index_player_profile_positions_on_position_id"
  end
